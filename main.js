...
const IMAGES_DIR = 'ezgif-44b67a6460b87b33-jpg';
const images = [];
let loadedCount = 0;
...
const cards = [
  { element: document.getElementById('hero-card'), start: 0.0, end: 0.12 },
  { element: document.getElementById('card-1'), start: 0.22, end: 0.42 },
  { element: document.getElementById('card-2'), start: 0.52, end: 0.72 },
  { element: document.getElementById('card-3'), start: 0.82, end: 0.98 }
];
...
// Order button micro-interaction
document.querySelectorAll('.btn-order').forEach(btn => {
  btn.addEventListener('click', (e) => {
    e.preventDefault();
    showToast("🌹 Order Placed! Feel the refreshing splash soon.");
  });
});
